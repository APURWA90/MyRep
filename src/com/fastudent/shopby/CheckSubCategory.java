...
public class CheckSubCategory extends TestSuiteBase {
	...
	public void testcaseA3() throws InterruptedException {
		...
		String part1="html/body/div[3]/div/div[1]/div[1]/div[2]/div/div/div/div/ul/li[1]/div/div/div/div/div/ul/li[";
		String part2="]/a/span";
		...
		for(int i=1;i<=10;i++)
		{
			...
			//driver.findElement(By.xpath("html/body/div[3]/div/div[1]/div[1]/div[2]/div/div/div/div/ul/li[1]/div"));
		...
		//	System.out.println("Number of images of---->"+text1 );
